...
Files 1.2.0 preserves reviewed target-field names. Its ten-file gate passed with
published CLI 0.16.1/core 0.12.5 and local provider 0.4.2 against both the
candidate tree and the immutable public `files-1.2.0` tag. The catalogue qualifies
Files 1.2.0 and local provider 0.4.2 for core 0.12.5. The separate retail gate
continues to use published Files 1.1.0.
